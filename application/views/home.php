              ...
              <div class="contents">
                ...
                <div class="search-bar">
                  <div class="search-inner">
                    <form class="search-form" method="post" action="main/search">
                      <div class="form-group inputwithicon">
                        <i class="lni-tag"></i>
                        <input type="text" name="pname" class="form-control" placeholder="Enter Photographers name">
                      </div>
                      <div class="form-group inputwithicon">
                        <i class="lni-map-marker"></i>
                        <div class="select" class="selectpicker">
                      ...
                      <div class="form-group inputwithicon">
                        <i class="lni-menu"></i>
                        <div class="select">
                          <select class="selectpicker"  name="category" class="selectpicker"> 
                            ...
                            <option value="productphotoshoot">Product photoshoot</option>
