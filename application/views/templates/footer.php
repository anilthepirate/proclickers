              ...
              <ul class="media-content-list">
                <li>
                  <div class="media-left">
                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/art/img1.jpg" alt="">
                    <div class="overlay">
                ...
                <li>
                  <div class="media-left">
                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/art/img2.jpg" alt="">
                    <div class="overlay">
          ...
          <div class="col-md-12">
            ...
            <div class="float-right">
              <ul class="bottom-card">
                <li>
                  <a href="#"><img src="<?php echo base_url(); ?>assets/img/footer/card1.jpg" alt="card"></a>
                </li>
                <li>
                  <a href="#"><img src="<?php echo base_url(); ?>assets/img/footer/card2.jpg" alt="card"></a>
                </li>
                <li>
                  <a href="#"><img src="<?php echo base_url(); ?>assets/img/footer/card3.jpg" alt="card"></a>
                </li>
                <li>
                  <a href="#"><img src="<?php echo base_url(); ?>assets/img/footer/card4.jpg" alt="card"></a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <!-- Easy autocomplete pluging js start -->
  <script>
    var options = {
      url: "<?php echo base_url(); ?>assets/resources/cities_db.json",
      getValue: "city_name",
      list: {
        match: {
          enabled: true
        ...
        onSelectItemEvent: function() {
          var value = $("#provider-json-city").getSelectedItemData().city_id; //get the id associated with the selected value
          //console.log(value)
    ...
    $("#provider-json-city").easyAutocomplete(options);
  </script>

  <script>
    var options = {
      url: "<?php echo base_url(); ?>assets/resources/categories.json",
    ...
    $("#provider-json-skill").easyAutocomplete(options);
  </script>

  <!-- Easy autocomplete pluging js end -->

  <!-- Light gallery pluging js start -->

  <script>
    $('#aniimated-thumbnials, .albums').lightGallery({
      thumbnail: true,
      download: false
    });
  </script>
